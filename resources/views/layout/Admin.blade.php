  ...
  <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
   ...
   <div class="container-fluid "style="background-color: #ffffff">
    <header class="navbar navbar-expand-lg bd-navbar bg-light fixed-top">
        <a href="{{route('AllEvents')}}" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none order-first postion-absolute top-0 start-0">
      ...
      <ul class="nav nav-underline mt-1 d-lg-flex d-none">
          <li class="nav-item">
              <a href="{{route('AllEvents')}}" class="nav-link link-success @if (request()->url()== route('AllEvents')||request()->url()== route('home')||request()->url()== route('index')) active @endif d-flex align-items-center" aria-current="page">
                  <svg class="bi bi-house me-1" fill="currentColor"  width="16" height="16"><use xlink:href="#calendar"></use></svg> Evènements
              </a>
          </li>
          <li class="nav-item">
              <a href="{{route('users')}}" class="nav-link link-success @if (request()->url()== route('users')) active @endif d-flex align-items-center" aria-current="page">
                  <svg class="bi bi-house me-1" fill="currentColor"  width="16" height="16"><use xlink:href="#person"></use></svg> users
              </a>
          </li>
          <li class="nav-item">
