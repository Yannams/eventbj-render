        ...
        <div class="row">
            ...
            <div class="card shadow mb-3 border-0 col-8 m-5" style="max-width: 540px;">
                <div class="d-flex align-items-center">
                  <div class="p-2 w-25">
                    <img src="{{asset($tickets->type_ticket->image_ticket)}}" class="img-fluid rounded-4 m-3" alt="..."  width="100px">
                  </div>
                  <div class="p-2">
                    <div class="card-body row">
                      ...
                      <div class="col-2"> <a href="{{route('downloadTicket',$tickets->id)}}" class="btn"><svg class="bi bi-download" fill="currentColor"  width="16" height="16"><use xlink:href="#download"></use></svg></a></div>
                    </div>
                  </div>
                </div>
              </div>
