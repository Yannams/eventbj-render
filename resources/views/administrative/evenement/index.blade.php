@extends('layout.Admin')
    ...
    @include('administrative.evenement.filterEvent')
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              @else
                                Activer l'évènement
                              @endif </button></li>
                              <li><a class="dropdown-item" href="{{route('Same_organiser',$evenement->profil_promoteur_id)}}">Du même organisateur</a></li>
